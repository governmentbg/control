...
<div class="ui teal segment">
    <form class="ui form" method="post">
        ...
        <div class="ui positive message">
            <div class="header"><?= $this->e($intl('common.login.restore_sent')) ?></div>
        </div>
        <?php else : ?>
            <?php if ($change) : ?>
                <div class="field">
            ...
            <?php else : ?>
                <div class="ui info message">
                    <div class="header"><?= $this->e($intl('common.login.restore_text')) ?></div>
                </div>
                <div class="field">
                    <div class="ui left icon input">
                        <i class="mail icon"></i>
                        <input type="text" name="mail" autofocus autocomplete="email"
                            placeholder="<?= $this->e($intl('common.login.restore_mail')) ?>" />
                    </div>
                </div>
                <div class="ui divider"></div>
                <button type="submit" class="ui labeled icon teal submit button login-submit-button">
                    <i class="sign in icon"></i>
                    <?= $this->e($intl('common.login.restore_send')) ?>
                </button>
            <?php endif; ?>
        <?php endif; ?>
    </form>
